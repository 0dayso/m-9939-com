 ...
 * 2015年9月6日
 */
class MemberblogController extends Q_Controller_Smarty{
	...
	public function detailAction(){
		...
		echo $this->view->render("memberblog/blogDetail.tpl", $md5URL);
	}
	...
	public function detailpageAction() {
		...
		$md5URL = md5($_SERVER['REQUEST_URI']);
		echo $this->view->render("memberblog/blogDetailPage.tpl", $md5URL);
	}
	...
	public function indexAction() {
		...
		$md5URL = md5($_SERVER['REQUEST_URI']);
		echo $this->view->render("memberblog/blogList.tpl", $md5URL);
	}
