 ...
 * 2015-08-26
 */
 class AskdoctorController extends Q_Controller_Smarty{
 	...
 	public function indexAction() {
 		...
 		echo $this->view->render('askdoctor/askdoctor.tpl', $md5URL);
 	}
 	...
 	public function commondiseaseAction() {
 		...
 		$md5URL = md5($_SERVER['REQUEST_URI']);
 		echo $this->view->render("askdoctor/commonDisease.tpl", $md5URL);
 	}
