...
* 日期 2015年5月
**/
class DiseaseController extends App_Controller_Action{
	...
	function indexAction(){
        $template_path = 'Disease/jibingzicha.tpl';
    ...
    function letterAction(){
        $template_path = 'Disease/letterchaxun.tpl';
        $url = md5($_SERVER['REQUEST_URI']);
        $this->display($template_path, $url);
    ...
    function disAction(){
        $template_path = 'Disease/jibingxq.tpl';
        $url = md5($_SERVER['REQUEST_URI']);
        $this->display($template_path, $url);
