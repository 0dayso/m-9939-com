...
<article class="doctor">
	<div><img src="<{$doctorBasicInfo.pic}>" alt="<{$doctorBasicInfo.nickname}>" title = "<{$doctorBasicInfo.nickname}>" ></div>
    <div>
    	<p>
    	...
    	<p>
    		<span><img src="/images/sta_01.png"></span>
    		<span><img src="/images/sta_01.png"></span>
    		<span><img src="/images/sta_01.png"></span>
    		<span><img src="/images/sta_02.png"></span>
    		<span><img src="/images/sta_02.png"></span>
    	</p>
    </div>
...
<section class="arti">
	...
	<div class="hand"><span>(<label><{$detailBlog.praise}></label>)</span></div></div>
     <!-- 分享部分 Start -->   
