...
<div class="main">
    ...
    <!--右上角快速导航 结束-->
    <!--6.1 修改-->
    <div class="m_shor"><a href="/<{$catdir.parentdir_url}>/"><{$catdir.parentdir_name}></a>&gt;<a href="javascript:"><{$catdir.catdir_name}></a>&gt;<a href="javascript:">正文</a></div>
    <!--ends-->
<!-- header ends -->
<!-- 主内容 stars -->
    ...
    <{if $zx_adstext}>
      <div class="n_add">
        <{foreach from=$zx_adstext item=ads}>
            <a href="<{$ads.newruleurl}>"><p style="color:#0000ff;"><{$ads.adsname}></p></a>
        <{/foreach}>
      </div>
    <{/if}>
    <!--百度联盟 开始-->
