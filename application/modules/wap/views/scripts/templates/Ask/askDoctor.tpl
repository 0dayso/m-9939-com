...
<article class="doctor docbo">
    ...
    <div class="macur">
    	<p><span><{$doctorBasicInfo.nickname}></span><{$doctorBasicInfo.zhicheng}></p>
    	<p><label>擅长：</label><{$doctorBasicInfo.best_dis}></p>
    </div>
</article>
